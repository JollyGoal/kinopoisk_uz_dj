    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users_rating', to='basesite.rating', verbose_name='Рейтинги')),
                ('reviews', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users_reviews', to='basesite.reviews', verbose_name='Отзывы')),
            ],
        ),
        migrations.AddField(
            model_name='rating',
            name='star',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basesite.ratingstar', verbose_name='звезда'),
        ),
        migrations.CreateModel(
            name='MovieShots',
            fields=[
