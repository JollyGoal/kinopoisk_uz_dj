    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_star', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users_rating', to='basesite.ratingstar', verbose_name='Рейтинги')),
                ('reviews', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users_reviews', to='basesite.reviews', verbose_name='Отзывы')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
